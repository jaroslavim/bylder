	...
	return (
		<Stack className="page-content heating-dashboard" gap="lg">
			<Group justify="space-between" align="flex-start">
				<div><Text className="eyebrow">Dashboard / HTG-01</Text><Title order={1}>Floor heating</Title><Text c="dimmed" mt={4}>{project?.name} <Badge ml="xs" variant="dot" color="teal">LOCAL MODE</Badge></Text></div>
